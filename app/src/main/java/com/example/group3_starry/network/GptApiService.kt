...
interface GptApiService {
    ...
    suspend fun getGptResponse(
        @Body request: GptRequest  // Use GptChatRequest instead of GptRequest
...
data class GptRequest(
    ...
    val messages: List<Map<String, String>>,         // Use List<Message> instead of List<Map<String, String>>
